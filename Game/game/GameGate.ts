...
class GameGate {
    ...
    private static addPlayerSceneObject(so: SceneObject, isEntity: boolean = false, insertNewPostion: boolean = true): void {
        ...
        if (typeof Game.player.sceneObject.inPartyIndex != "undefined") Game.player.sceneObject.inPartyIndex = 0;
