...
class Controller {
    ...
    static get inSceneEnabled() {
        ...
        // 打开了相关界面时:3号
        if ((GameDialog.isInDialog || (GameUI.get(3) && GameUI.get(3).stage))) {
            return false;
        }
        // 当前操控的角色如果已死亡的话
        // if (Game.ctrlActorSceneObject.duringRelease || Game.ctrlActorSceneObject.finalAttr.isDead) return false;
